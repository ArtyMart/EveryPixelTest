...
namespace UnitTest
{
	...
	public:
		...
		TEST_METHOD(TestReadConfig)
		{
			...
			expected_config.rootPath = "E:\\\\work\\\\projects\\\\EveryPixelTest\\\\test";
			...
			Microsoft::VisualStudio::CppUnitTestFramework::Assert::AreEqual(expected_config.rootPath, actual_config.rootPath);
			for (int i = 0; i < 3; i++)
			{
